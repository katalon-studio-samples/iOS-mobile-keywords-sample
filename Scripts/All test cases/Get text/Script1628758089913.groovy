...
//get text of the textbox right after inpputing value for it
...
String value = Mobile.getText(txtElem, 0)

//verify value inputting to the textbox is the expected one
Mobile.verifyMatch(inputText, value, false)
